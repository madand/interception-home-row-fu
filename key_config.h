...
DEFINE_MAPPING(KEY_S, KEY_LEFTMETA, true)
DEFINE_MAPPING(KEY_L, KEY_RIGHTMETA, true)

DEFINE_MAPPING(KEY_D, KEY_LEFTSHIFT, true)
DEFINE_MAPPING(KEY_K, KEY_RIGHTSHIFT, true)
